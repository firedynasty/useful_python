...
def create_reporting_dataset(four_factors_df, schedule_df, output_dir):
    ...
    home_cols = ['game_id', 'Game_Date', 'Box_Score_URL', 'Home_Team_Name', 'Home_Score', 
                 'Game_Pace', 'Home_eFG_PCT', 'Home_TOV_PCT', 'Home_ORB_PCT', 
                 'Home_FT_Rate', 'Home_ORtg']
    
    away_cols = ['game_id', 'Away_Team_Name', 'Away_Score', 'Away_eFG_PCT', 
                 'Away_TOV_PCT', 'Away_ORB_PCT', 'Away_FT_Rate', 'Away_ORtg']
    ...
    col_order = [
        # Game info
        'Date', 'Game_Date', 'Time', 'Arena', 'Attendance', 'Game_Duration', 'Overtime',
        
        # Away team
        'Away_Team_Name', 'Away_Score', 'Away_eFG_PCT', 'Away_TOV_PCT', 
        'Away_ORB_PCT', 'Away_FT_Rate', 'Away_ORtg',
        
        # Home team
        'Home_Team_Name', 'Home_Score', 'Home_eFG_PCT', 'Home_TOV_PCT',
        'Home_ORB_PCT', 'Home_FT_Rate', 'Home_ORtg',
...
def main():
    ...
    print("\n" + "="*80)
    print("INTERACTIVE FOUR FACTORS SCRAPER")
    print("="*80)
