"""
make_adjusted.py (Spanish)

Reads a lyrics CSV, splits each cell by newlines,
pairs translation + Spanish line by line.
...
parser.add_argument("--input", default="spanish_table.csv", help="Path to lyrics CSV")
parser.add_argument("--output", default="spanish_adjusted.txt", help="Path for output txt")
