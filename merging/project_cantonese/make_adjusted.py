"""
make_adjusted.py (Cantonese)

Reads a lyrics CSV, splits each cell by newlines,
pairs translation + Jyutping line by line.
...
parser.add_argument("--input", default="cantonese_table.csv", help="Path to lyrics CSV")
parser.add_argument("--output", default="cantonese_adjusted.txt", help="Path for output txt")
...
if "jyutping" in header:
    rom_col = header.index("jyutping")
elif "pinyin" in header:
