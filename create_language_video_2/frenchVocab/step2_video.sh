...
# step2_video.sh
#
# Burns dual subtitles (French top, English bottom) onto
...
# Two subtitle tracks: French (top), English (bottom)
ffmpeg -y \
...
# === French-only test video (no English) ===
echo ""
echo "=== Creating French-only test video ==="
