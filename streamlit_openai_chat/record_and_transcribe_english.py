...
def transcribe_audio_segment(segment_path, sample_rate):
    ...
    try:
        ...
        credentials = service_account.Credentials.from_service_account_file("/Users/stanleytan/Documents/46-python/streamlit_openai_chat/service_account_key.json")
        client = speech.SpeechClient(credentials=credentials)
        print("Using credentials from: /Users/stanleytan/Documents/46-python/streamlit_openai_chat/service_account_key.json")
    except Exception as e:
...
def transcribe_audio(audio_file_path):
    ...
    try:
        ...
        print(f"Authentication error: {e}")
        print("Please make sure the service account key file exists at:")
        print("/Users/stanleytan/Documents/46-python/streamlit_openai_chat/service_account_key.json")
        return None
