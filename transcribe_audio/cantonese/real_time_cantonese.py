...
def transcribe_audio(audio_file_path):
    ...
    # You can change the language code based on what type of Chinese you're transcribing
    # Mandarin: zh-CN or zh-TW
    # Cantonese: yue-Hant-HK
    config = speech.RecognitionConfig(
        encoding=speech.RecognitionConfig.AudioEncoding.LINEAR16,
        sample_rate_hertz=SAMPLE_RATE,
        language_code="zh-CN",  # Change this to match your Chinese dialect
...
def main():
    ...
    print("=== Continuous VB-Cable Chinese Transcription ===")
