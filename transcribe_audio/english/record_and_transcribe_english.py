...
def transcribe_audio_segment(segment_path, sample_rate):
    ...
    try:
        ...
        english_credentials = os.environ.get("GOOGLE_APPLICATION_CREDENTIALS_ENGLISH")
        if english_credentials:
            print(f"Using English-specific credentials from: {english_credentials}")
            credentials = service_account.Credentials.from_service_account_file(english_credentials)
            client = speech.SpeechClient(credentials=credentials)
        else:
            # Fall back to default credentials
            print("No English-specific credentials found, using default credentials")
...
def transcribe_audio(audio_file_path):
    ...
    try:
        ...
        print("Then set it in your environment as GOOGLE_APPLICATION_CREDENTIALS_ENGLISH")
        return None
