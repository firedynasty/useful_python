"""
create_video_no_clipboard.py

Combines selected files into a single video using a filelist.
Used by the create_video_from_files Automator Quick Action.

Usage:
  python create_video_no_clipboard.py --filelist /tmp/create_video_files.txt
"""
...
parser = argparse.ArgumentParser(
    description="Combine files from a list into a video.")
parser.add_argument("--filelist", required=True, help="Text file with one file path per line")
